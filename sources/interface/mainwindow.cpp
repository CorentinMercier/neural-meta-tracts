    ...
    QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    connect(ui->slider,SIGNAL(sliderReleased()), this, SLOT(action_slider()));
    connect(ui->geometrySlider,SIGNAL(sliderMoved(int)), this, SLOT(action_geometry_slider()));
    connect(ui->geometrySlider,SIGNAL(sliderReleased()), this, SLOT(action_geometry_slider()));
